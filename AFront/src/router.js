...
const routes = [
  ...
  },
  {
    path: '/music',
    name: 'music',
    component: require('./views/blog.music.vue').default
  },
  {
    path: '/login',
    name: 'login',
    ...
    children: [
      {
        path: 'art-list',
        name: 'artList',
        component: require('./views/blog.articleList.vue').default
      },
      {
        path: 'his-list',
        name: 'historyList',
        component: require('./views/blog.historyList.vue').default
      },
      {
        path: 'tag-list',
        name: 'tagList',
        ...
        children: [
          {
            ...
            component: require('./views/blog.tagList.vue').default
          },
          {
            path: 'find-by-tag-id',
      ...
      },
      {
        path: 'friends',
        name: 'friends_link',
        component: require('./views/blog.friends.vue').default
      }
    ]
  },
  {
